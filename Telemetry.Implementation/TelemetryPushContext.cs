...
namespace Telemetry.Implementation
{
    ...
    public class TelemetryPushContext :
        ITelemetryPushContext
    {
        private readonly ITelemetryPushContext[] _pushs;
        public TelemetryPushContext(params ITelemetryPushContext[] pushs)
        {
            _pushs = pushs;
        }
        ...
        public void PushToken<T>(string tokenKey, T tokenValue)
        {
            ...
            {
                push.PushToken(tokenKey, tokenValue);
            }
        }
